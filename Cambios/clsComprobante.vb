...
Public Class clsComprobante
    ...
    Public Sub GeneraXML_Basico(ByVal PATH_salida As String)
        ...
        With mywriter
            ...
            .WriteAttributeString("xsi:schemaLocation", "http://www.sat.gob.mx/cfd/2 http://www.sat.gob.mx/sitio_internet/cfd/2/cfdv2.xsd")
            ...
            If Me.leyenda <> "" Then
                ...
                .WriteStartElement("finagil:addenda_finagil")
                .WriteAttributeString("xmlns:finagil", "http://www.finagil.com.mx/cfd")
                .WriteAttributeString("xmlns:xsi", "http://www.w3.org/2001/XMLSchema-instance")
                .WriteAttributeString("xsi:schemaLocation", "http://www.finagil.com.mx/cfd http://www.finagil.com.mx/cfd/addenda_finagil.xsd")
                .WriteStartElement("operacion")
                .WriteAttributeString("monto", Me.monto.ToString)
                .WriteAttributeString("iva", Me.iva.ToString)
                .WriteEndElement()                                                          ' operacion fin
                .WriteEndElement()                                                          ' finagil:addenda_finagil fin
                .WriteEndElement()                                                          ' Addenda fin
            End If
