...
Module mCFD
    ...
    Public Sub CFD(ByRef newCFD As clsComprobante)
        ...
        dtComprobante.Columns.Add("metodoDePago", Type.GetType("System.String"))        ' Este campo no aparece en el XML sólo en el PDF
        ...
        drComprobante("metodoDePago") = newCFD.metodoDePago
